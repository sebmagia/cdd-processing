...
if step_1:
    ...
    #data_new=np.vstack((data3,data1,data4,data2)).T

    #data_new=np.vstack((data1,data2,data3,data4,data5)).T
    data_new=np.vstack((data3,data1,data4,data2,data5)).T
...
if step_2:
    ...
    trace5=obspy.Trace(data=data4,header={'sampling_rate':fs,'network':nw,'station':'E5'})
...
if step_4:
    ...
    plt.savefig('Coh_2.png', format='png', dpi=300)
