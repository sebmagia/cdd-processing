...
path_cdd='/home/doctor/Doctor/Magister/Tesis/databases/process_data/CDD_TOMO_JAN/'
    ...
    if gen_setup:
        ...
        for seed in seeds:
            for lr in lrs:
                ...
                bedrock = np.array([vmax*(1-fac), 1000, 2.0, 0.45, 1500, 0.0, 0.0]).reshape((7, 1))
                nl = len(hmin) + 1
                nsl = len(hmin)
                a, b = [1290., 1.11]
                fixhv = 9999
